...
/** Clientes scoreados con datos ricos: segmento, accion_retencion, prob_abandono, etc. */
export function getClientesScoreados() {
  return apiGet(`${ML_BASE}/clientes-scoreados`)
}
